...
def get_spike_data_multiple_areas(cache, session, my_areas, amplitude_cutoff_maximum = 0.1, presence_ratio_minimum = 0.9, isi_violations_maximum = 0.5):
    ...
    my_units = units_channels.query("structure_acronym in {}".format(my_areas))
